...
export default function DetalleDestino() {
  ...
  const galeria = [
    { id: 'g1', imagen: require('../assets/panecillos2.jpg') },
    { id: 'g2', imagen: require('../assets/panecillo2.jpg') },
    { id: 'g3', imagen: require('../assets/panecillo3.jpg') },
    { id: 'g4', imagen: require('../assets/panecillo4.jpg') },
  ];
    ...
    <SafeAreaView style={styles.safeArea} edges={['bottom', 'left', 'right']}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.promocion}>
          <Image source={require('../assets/panecillo.jpg')} style={styles.imagenPromocional} />
