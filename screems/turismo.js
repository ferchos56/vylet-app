...
const lugares = [
  {
    ...
    distancia: 60,
    imagen: require('../assets/panecillo.jpg'),
  ...
  },
  {
    ...
    descripcion: 'Esta toma se encuentra en el centro de Quito y ofrece una vista panorámica de la ciudad',
    distancia: 100,
    imagen: require('../assets/basilica.jpg'),
    destino: 'detalleDestino',
  },
  {
    id: '3',
    ...
    descripcion: 'Esta toma se encuentra en el centro de Quito y ofrece una vista panorámica de la ciudad',
    distancia: 30,
    imagen: require('../assets/cima.jpg'),
    destino: 'detalleDestino',
  },
  {
    id: '4',
    ...
    descripcion: 'Esta toma se encuentra en el centro de Quito y ofrece una vista panorámica de la ciudad',
    distancia: 20,
    imagen: require('../assets/plaza.jpg'),
    destino: 'detalleDestino',
  },
];
...
export default function ExplorarLugares() {
