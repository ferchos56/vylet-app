...
export default function FestividadesEcuador() {
  ...
  const festividades = [
    {
      ...
      descripcion: '',
      imagen: require('../assets/quito.jpg'),
      distancia: 5,
    },
    {
      id: 'f2',
      ...
      imagen: require('../assets/ibarra.jpg'),
      distancia: 80,
    },
    {
      id: 'f3',
      ...
      evento: 'Fiestas de Quito',
      descripcion: 'Sumérgete en festividades propias de la ciudad de Quito en honor a su historia.',
      imagen: require('../assets/cuencafiesta.jpeg'),
      distancia: 300,
    },
    {
      id: 'f4',
      ...
      evento: 'Fiestas de Quito',
      descripcion: 'Sumérgete en festividades propias de la ciudad de Quito en honor a su historia.',
      imagen: require('../assets/lijafiesta.jpeg'),
      distancia: 500,
    },
  ];
