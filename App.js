...
import InformacionPersonalConfig from "./screens/InformacionPersonalConfig.js";
import SeguridadConfig from "./screens/SeguridadConfig.js";
import Configuraciones from "./screens/Configuraciones.js";
        ...
        <AdminProvider>
          <UserProvider>
            <HotelProvider>
              <NavigationContainer>
                <Stack.Navigator
                  initialRouteName={esPrimeraVez ? "permisos" : "HomeScreem"}
                >
                  <Stack.Screen
                    name="permisos"
...
>>>>>>> upstream/main
                  ...
                  />
                  <Stack.Screen
                    name="detallesFiestas"
                    component={DetallesFiestas}
                    options={({ navigation }) => ({
                      ...baseHeader("Fiesta"),
                      headerRight: () => (
                        <TouchableOpacity
                  ...
                  />
                  <Stack.Screen
                    name="detallesRestaurantes"
                    component={DetallesRestaurantes}
                    options={({ navigation }) => ({
                  ...
                  <Stack.Screen
                    name="formularioEdicionCiudad"
                    component={FormularioEdicionCiudad}
                    options={({ navigation }) => ({
                      ...baseHeader("Edicion"),
                      headerRight: () => (
                        <TouchableOpacity
                  ...
                  />
                  <Stack.Screen
                    name="formularioEdicionDiversion"
                    component={FormularioEdicionDiversion}
                    options={({ navigation }) => ({
                      ...baseHeader("Edicion"),
                      headerRight: () => (
                        <TouchableOpacity
                  ...
                  />
                  <Stack.Screen
                    name="formularioEdicionHoteles"
                    component={FormularioEdicionHoteles}
                    options={({ navigation }) => ({
                      ...baseHeader("Edicion"),
                      headerRight: () => (
                        <TouchableOpacity
                  ...
                  <Stack.Screen
                    name="informacionPersonalConfig"
