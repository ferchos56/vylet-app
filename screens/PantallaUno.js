...
const banners = [
  {
    id: '1',
    image: 'https://cdn.dribbble.com/userupload/13118950/file/original-cfaebacb75910a02e08e618b7ab2a067.jpg',
    title: '¡Solo por tiempo limitado!',
    text: 'Escoge tus metas, corre corriendo',
  },
  {
    id: '2',
    image: 'https://www.pichincha.com/sites/default/files/styles/hero_landing/public/2025-10/banner-home-mundial-4.jpg.webp?itok=DwvNUi6N',
    title: 'Compra con Banco Pichincha',
    text: 'Por tus compras rembolsa 5%',
  },
  {
    id: '3',
    image: 'https://img.freepik.com/psd-gratis/plantilla-banner-portada-facebook-menu-comida-restaurante_120329-5497.jpg',
...
const PantallaUno = () => {
  ...
  const { usuario, cargandoLocalizacion } = useUser();
  ...
  useEffect(() => {
    const scroll = () => {
      if (flatListRef.current) {
        flatListRef.current.scrollToOffset({ offset: width * 1, animated: true });

        setTimeout(() => {
          flatListRef.current.scrollToOffset({ offset: width * 2, animated: true });
        ...
        {isVerMas ? (
          <TouchableOpacity>
            <LinearGradient
              ...
              style={{ width: width - 25, height: 100, justifyContent: 'center', padding: 30, borderRadius: 20 }}
            >
              <View style={{ color: 'white', fontSize: 18, marginHorizontal: 10, flexDirection: "row", gap: 10, alignItems: "center", justifyContent: "center" }}>
            ...
            >
              ...
              >
                <View style={{ width: 170 }}>
                  ...
                  {item.text ? <Text style={{ color: '#dadadaff' }} numberOfLines={2}>{item.text}</Text> : null}
                </View>
              </LinearGradient>
            </ImageBackground>
          </TouchableOpacity>
  ...
  if (cargandoLocalizacion) {
    return (
      <CargandoOverlay message={"Cargando informacion"} />
    )
  }
      ...
      <ScrollView style={styles.scroll}>
        <View style={styles.containerWelcom}>
          <View style={styles.insadeWelcom}>
            <View style={styles.insadeFrits}>
              <View>
                <TouchableOpacity onPress={() => navigation.navigate('PerfilModal')}>
                  <Image source={imagen ? { uri: imagen } : require('../assets/vyletlogo.jpg')} style={styles.profileImage} />
                </TouchableOpacity>
              </View>
              <View>
            ...
            <View style={styles.insadeSecond}>
              ...
              <TouchableOpacity>
                ...
                <MaterialCommunityIcons name="bell-ring" size={25} color="#fff" />
              </TouchableOpacity>
        ...
        <View style={styles.categories}>
          ...
          >
            {[
              ...
              { label: 'Diversión', icon: 'emoticon-happy', destino: 'diversion' },
              ...
              <View style={styles.categoryCard} key={index}>
                <View>
                  ...
                  >
                    <MaterialCommunityIcons name={item.icon} size={35} color="rgba(255, 255, 255, 1)" />
                  </TouchableOpacity>
                  <Text style={{ ...styles.categoryText, color: "#fff" }}>{item.label}</Text>
                </View>
              </View>
            ))}
          </ScrollView>
        ...
        <View style={styles.activities}>
          ...
          <View style={styles.recomendations}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scrollRecomedations}>
              <View style={styles.card}>
                <Image
                  source={{ uri: "https://res.cloudinary.com/dtomqkhpu/image/upload/v1759520145/ciudades/o2am76b0daytmi11y7eo.jpg" }}
                  style={styles.cardImage}
                />
                <View style={styles.bodyCard}>
                  <Text style={styles.cardTitle}>LA QUINTA BY WYNDHAM QUITO</Text>
                  <Text style={{ ...styles.cardSubtitle, fontSize: 13 }}>Hotel de lujo quito libre para poder visitar La Carolina</Text>
              ...
              <View style={styles.card}>
                <Image
                  source={{ uri: "https://res.cloudinary.com/dtomqkhpu/image/upload/v1759520144/ciudades/ppw2tcserdeatyqy9clc.jpg" }}
                  style={styles.cardImage}
                />
                <View style={styles.bodyCard}>
                  <Text style={styles.cardTitle}>LA QUINTA GUAYAQUIL</Text>
                  <Text style={{ ...styles.cardSubtitle, fontSize: 13 }}>Hotel de lujo quito libre.</Text>
                  <Text style={styles.cardPrice}>Precio: 10 - 100 $</Text>
                </View>
              </View>
            </ScrollView>
